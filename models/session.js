...
const sessionSchema = new Schema({
  ...
  members: { type: [{ name: String, numCorrect: Number, numIncorrect: Number, newGuess: String, guessStatus: Number, waitingOnEval: Boolean, numGuesses: Number }], required: true },
